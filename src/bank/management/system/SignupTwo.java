...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        // ✅ Senior Citizen group (only one can be selected)
        ButtonGroup seniorGroup = new ButtonGroup();
        seniorGroup.add(r1);
        seniorGroup.add(r2);
        
        // ✅ Existing Account group (only one can be selected)
        ...
        c2.setBounds(350,172,320,30);
        add(c2);
        
        String income[] = {"Select","<1,50,000","<2,50,000","<5,00,000","Upto 10,00,000","Above 10,00,000"};
